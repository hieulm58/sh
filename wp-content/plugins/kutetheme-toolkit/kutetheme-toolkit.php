...
if( !function_exists('kt_themeOptionPage')){
    function kt_themeOptionPage(){
        ...
        add_submenu_page( 'kt_capnel_page', 'KuteShop Dashboard', 'Dashboard', 'manage_options', 'kt_capnel_page',  'kt_wellcome' );
    }
}
        ...
        <div class="wrap redapple-wrap">
            <div class="welcome-panel">
                <div class="welcome-panel-content">
                    <h2><?php esc_html_e('Welcome to Kuteshop!','kutetheme');?></h2>
                    <p class="about-description"><?php esc_html_e('We\'ve assembled some links to get you started','kutetheme');?></p>
                    <div class="welcome-panel-column-container">
                        <div class="welcome-panel-column">
                            <h3><?php esc_html_e('Get Started','kutetheme');?></h3>
                            <a target="_blank" href="http://kutethemes.net/wordpress/kuteshop/" class="button button-primary button-hero trigger-tab"><?php esc_html_e('View All Demos','kutetheme');?></a>
                        </div>
                        <div class="welcome-panel-column">
                            <h3><?php echo esc_html_e('Next Steps','kutetheme');?></h3>
                            <ul>
                                <li><a target="_blank" href="#" class="welcome-icon dashicons-media-document"><?php esc_html_e('Read Documentation','kutetheme')?></a></li>
                                <li><a target="_blank" href="http://support.ovicsoft.com/support-system" class="welcome-icon dashicons-editor-help"><?php esc_html_e('Request Support','kutetheme');?></a></li>
                                <li><a target="_blank" href="http://kutethemes.net/wordpress/kuteshop/changelog_kuteshop-wp.txt" class="welcome-icon dashicons-backup"><?php esc_html_e('View Changelog Details','kutetheme');?></a></li>
                            </ul>
                        </div>
                        <div class="welcome-panel-column">
                            <h3><?php esc_html_e('Keep in Touch','kutetheme');?></h3>
                            <ul>
                                <li><a target="_blank" href="#" class="welcome-icon dashicons-email-alt"><?php esc_html_e('Newsletter','kutetheme');?></a></li>
                                <li><a target="_blank" href="#" class="welcome-icon dashicons-twitter"><?php esc_html_e('Twitter','kutetheme');?></a></li>
                                <li><a target="_blank" href="https://www.facebook.com/kutethemes" class="welcome-icon dashicons-facebook"><?php esc_html_e('Facebook','kutetheme');?></a></li>
                            </ul>
                        </div>
                    </div>
