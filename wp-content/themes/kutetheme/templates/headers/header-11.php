    ...
    <div class="container">
        <div class="block-header-top12">
            <div class="inner">
	            ...
	            $kt_vertical_menu_title  = kt_option('kt_vertical_menu_title','Categories');
		        $kt_vertical_menu_button_all_text  = kt_option('kt_vertical_menu_button_all_text','All Categories');
		        $kt_vertical_menu_button_close_text  = kt_option('kt_vertical_menu_button_close_text','Close');
	            ...
	            <div class="block-vertical">
	                <div id="box-vertical-megamenus" class="vertical-wapper">
	                    <div data-items="<?php echo esc_attr( $kt_vertical_item_visible );?>" class="box-vertical-megamenus <?php if( $kt_click_open_vertical_menu =="enable") echo esc_attr( 'hiden_content' );?>">
	                        <h4 class="title">
		                        <span class="title-menu"><?php echo esc_html( $kt_vertical_menu_title ); ?></span>
		                        <span class="btn-open-mobile home-page"><i class="fa fa-bars"></i></span>
		                    </h4>
		                    <div class="vertical-menu-content">
		                        <?php kt_setting_vertical_menu(); ?>
		                        <div class="all-category"><span data-open_text="<?php echo esc_html( $kt_vertical_menu_button_all_text )?>" data-close_text="<?php echo esc_html($kt_vertical_menu_button_close_text)?>" class="open-cate"><?php echo esc_html( $kt_vertical_menu_button_all_text )?></span></div>
		                    </div>
	                    </div>
	                </div>
	            </div>
